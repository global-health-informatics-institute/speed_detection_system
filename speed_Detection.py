...
# Check for speed info from OPS241-A
    ...
    if (Ops241_rx_bytes_length != 0) :
            ...
            if Ops241_rx_str.find('{') == -1 :
                # Speed data found
                Ops241_rx_float = float(Ops241_rx_bytes) * 1.60934
...
def show_on_display(digit, display):
    if display == 1:
        ...
        pins = {
            '1': [segment2_data2,segment2_data4],
            '2': [segment2_data1,segment2_data2,segment2_data3,segment2_data6,segment2_data5],
            '3': [segment2_data1,segment2_data2,segment2_data3,segment2_data4,segment2_data5],
            '4': [segment2_data2,segment2_data3,segment2_data6,segment2_data7],
            '5': [segment2_data1,segment2_data3,segment2_data4,segment2_data5,segment2_data7],
            '6': [segment2_data1,segment2_data6,segment2_data7,segment2_data3,segment2_data4,segment2_data5],
            '7': [segment2_data1,segment2_data2,segment2_data4],
            '8': [segment2_data1,segment2_data2,segment2_data3,segment2_data4,segment2_data5,segment2_data6,segment2_data7],
            '9': [segment2_data1,segment2_data2,segment2_data3,segment2_data4,segment2_data5,segment2_data7],
            '0': [segment2_data1,segment2_data2,segment2_data7,segment2_data4,segment2_data5,segment2_data6]
        }
        ...
        pins = {
            '1':[segment_data2,segment_data4],
            '2':[segment_data1,segment_data2,segment_data3,segment_data6,segment_data5],
            '3':[segment_data1,segment_data2,segment_data3,segment_data4,segment_data5],
            '4':[segment_data2,segment_data3,segment_data6,segment_data7],
            '5':[segment_data1,segment_data3,segment_data4,segment_data5,segment_data7],
            '6':[segment_data1,segment_data6,segment_data7,segment_data3,segment_data4,segment_data5],
            '7':[segment_data1,segment_data2,segment_data4],
            '8':[segment_data1,segment_data2,segment_data3,segment_data4,segment_data5,segment_data6,segment_data7],
            '9':[segment_data1,segment_data2,segment_data3,segment_data4,segment_data5,segment_data7],
            '0':[segment_data1,segment_data2,segment_data7,segment_data4,segment_data5,segment_data6]
